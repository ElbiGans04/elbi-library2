...
Route.get("/", async function (req, res) {
  try {
    ...
    res.render("table", {
        ...
        as: [
            moduleLibrary.as({show: true, target: 'book_id', showName: 'Book', type: 'select', without: [0], value: resultBook}),
            moduleLibrary.as({target: 'member_id', showName: 'Member', type: 'select', value: resultMember})
        ],
        buttonAction: false
    });
